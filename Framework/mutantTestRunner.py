...
shutil.copy('./src/test/scala/at/tugraz/ist/qs2024/MessageBoardSpecification.scala', './Mutants/src/test/scala/at/tugraz/ist/qs2024/')
...
for index, mutant_jar in enumerate(mutant_files):
    ...
    output = ''
    with open('./Mutants/build/reports/tests/test/classes/at.tugraz.ist.qs2024.MessageBoardSpecificationTest.html', 'r') as file:
        output = file.read()
